...
initializeBtn.onclick = () => {
  ...
  document.querySelector("input[name='km_min']").value = "1000";
  document.querySelector("input[name='km_max']").value = "700000";
 // document.querySelector(".noUi-base > .noUi-connect").style.left = "0%";
 // document.querySelector(".noUi-base > .noUi-background").style.left = "100%";
