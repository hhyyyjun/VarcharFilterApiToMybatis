package com.lee.biz.controller;
...
public class ManagerController {
	...
	public String ManagerPage(MemberVO mvo, CarVO cvo, Model model,HttpServletRequest request) {
		String referer = (String)request.getHeader("Referer"); //다음 url 이동했을 때 이전의 url 확인 용도
	...
	public String updateCar(@ModelAttribute("data")CarVO cvo, MultipartHttpServletRequest multipartRequest,HttpServletRequest request) throws IllegalStateException, IOException {
		String referer = (String)request.getHeader("Referer"); //다음 url 이동했을 때 이전의 url 확인 용도
		System.out.println("referer 값 : "+referer);
	...
	public String selectCar(CarVO cvo, Model model,HttpSession session,HttpServletRequest request) {
		String referer = (String)request.getHeader("Referer"); //다음 url 이동했을 때 이전의 url 확인 용도
		System.out.println("referer 값 : "+referer);
	...
	public String deleteCar(@ModelAttribute("data")CarVO cvo,SessionStatus sessionStatus,HttpServletRequest request) {
		String referer = (String)request.getHeader("Referer"); //다음 url 이동했을 때 이전의 url 확인 용도
		System.out.println("referer 값 : "+referer);
	...
	public String Clear(SessionStatus sessionStatus, HttpSession session,HttpServletRequest request) {
		String referer = (String)request.getHeader("Referer"); //다음 url 이동했을 때 이전의 url 확인 용도
		System.out.println("referer 값 : "+referer);
